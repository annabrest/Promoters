...
k <- 16
 for (i in 1:4){
  ggsave(paste0("Plots/Brapa_distance_to_TSS_vs_TF_binding_score_fixed_y_", i, ".jpg"), marrangeGrob(grobs = plot[j:k], nrow=4, ncol=4))
 j <- j+16
 k <- k + 16
 }

for (i in 1:4){
  ggsave(paste0("Plots/Brapa_distance_to_TSS_vs_TF_binding_score_free_y_", i, ".jpg"), marrangeGrob(grobs = plot1[j:k], nrow=4, ncol=4))
 j <- j+16
 k <- k + 16
 }
